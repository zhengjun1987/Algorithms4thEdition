...
public class HalfCloseSocket {
    public static void main(String[] args) {
        System.out.println(MyUtils.getCurrentTime() + "((0+10)>>>1) = " + ((0 + 10) >>> 1));
        System.out.println(MyUtils.getCurrentTime() + "((0+11)>>>1) = " + ((0 + 11) >>> 1));
        System.out.println(MyUtils.getCurrentTime() + "((0+9)>>>1) = " + ((0 + 9) >>> 1));

        System.out.println(MyUtils.getCurrentTime() + "(-2 >>> 1) = " + (-2 >>> 1));
        System.out.println(MyUtils.getCurrentTime() + "(-2 >> 1) = " + (-2 >> 1));
        try {
